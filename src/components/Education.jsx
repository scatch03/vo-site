...
const Education = () => {
    return (
        <section id='cv' className='education'>
            ...
            <p className='education__description'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores molestias perferendis explicabo, corrupti tempora maiores quaerat odit voluptas recusandae totam doloribus.</p>
            <div className='education__list'>   
              <div className='education__card'>
                <div className='education__institution'>
                  <div className='education__institution-name'>
                    <a className='education__link' href="http://upml.knu.ua/" target="_blank" rel="noopener noreferrer">
                      <img className='education__logo' src={upml} alt='UPML Logo' />
                      Ukrainian Physics and Mathematics Lyceum
                    </a>
                  </div> 
                  <div className='education__detail'> Student
                     <span className='education__years'>Sep 2002 - Jun 2005</span>
                  </div>
                </div>
                <div className='education__text'>
                  <h5 className='education__text-title'>Certificate of Secondary Education</h5>
              ...
              <div className='education__card'>
                <div className='education__institution'>
                  <div className='education__institution-name'>
                    <a className='education__link' href="https://knu.ua/en/" target="_blank" rel="noopener noreferrer">
                      <img className='education__logo' src={knu} alt='KNU Logo' />
                      National Taras Shevchenko University of Kyiv
                    </a>
                  </div> 
                  <div className='education__detail'> Student
                     <span className='education__years'>Sep 2005 - Jun 2009</span>
                  </div>
                </div>
                <div className='education__text'>
                  <h5 className='education__text-title'>BSc of Applied Physics</h5>
                  <p className='education__text-description'>
              ...
              <div className='education__card'>
                <div className='education__institution'>
                  ...
                  <div className='education__detail'> Student
                     <span className='education__years'>Sep 2009 - Jun 2011</span>
                  </div>
                </div>
                <div className='education__text'>
                  <h5 className='education__text-title'>
                    MSc of Radiophysics and Electronics
                    <span className='education__honors'>with honors</span>
                  </h5>
                  <p className='education__text-description'>
              ...
              <div className='education__card'>
                <div className='education__institution'>
                  <div className='education__institution-name'>
                    <a className='education__link' href="https://kpi.ua/en/" target="_blank" rel="noopener noreferrer">
                      <img className='education__logo education__logo--kpi' src={kpi} alt='KPI Logo' />
                      National Technical University of Ukraine
                      "Igor Sikorsky Kyiv Polytechnic Institute"
                    </a>
                  </div> 
                  <div className='education__detail'> Student
                     <span className='education__years'>Sep 2022 - Jun 2025</span>
                  </div>
                </div>
                <div className='education__text'>
                  <h5 className='education__text-title'>
              ...
              <div className='education__card'>
                <div className='education__institution'>
                  <div className='education__institution-name'>
                    <a className='education__link' href="https://www.kpi.kharkov.ua/eng/" target="_blank" rel="noopener noreferrer">
                      <img className='education__logo' src={khpi} alt='KHPI Logo' />
                      National Technical University of Ukraine
                      "Kharkiv Polytechnic Institute" 
                    </a>
                  </div> 
                  <div className='education__detail'> Student
                     <span className='education__years'>Sep 2023 - Dec 2024</span>
                  </div>
                </div>
                <div className='education__text'>
                  <h5 className='education__text-title'>
                    MSc of Software Engineering
                    <p className='education__honors'>with honors</p>
                  </h5>
                  <p className='education__text-description'>
